...
- SYSTEM_PROMPT here MUST stay byte-identical to MOYU_SYSTEM_PROMPT in
  minicpm-sidecar/gateway/server.py. If you drift these out of sync, the
  LoRA imprint and inference prompt disagree and the persona breaks at
  runtime (the v5–v8 zhiyuan lesson).
